  ...
  render() {
    ...
    return (
      <div className="App">
        ...
        <TextSection title='Logistics' text={logisticsText} classes='content-block'/>
        <TextSection title='Registry' text={registryText} classes='content-block gray-bg'/>
        <div className="pic-break"/>
        <TextSection title='Our Story' text={storyText} classes='content-block'/>
        <TextSection title='FAQ' text={faqText} classes='content-block gray-bg'/>
